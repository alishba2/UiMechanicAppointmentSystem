          ...
          <div className="black-divs-container">
            <div className="black-div">
              <p className="black-div-text">
                ...
                Expert diagnostics to quickly identify and resolve any issues
                with your vehicle. Skilled mechanics ready to tackle any repair,
                big or small. Transparent pricing and detailed explanations of
                the work needed.
              </p>
            </div>
            <div className="black-div">
              <p className="black-div-text">
                ...
                24/7 emergency service to get you back on the road safely. Quick
                response times and reliable repairs to minimize downtime. Peace
                of mind knowing help is just a call away in case of emergencies.
              </p>
            </div>
            <div className="black-div">
              <p className="black-div-text">
                <h5>Scheduled Maintenance:</h5>
                Ensure your vehicle is in top condition with our scheduled
                maintenance service. Regular check-ups and tune-ups to prevent
                costly repairs down the road. Keep track of your maintenance
                schedule with our convenient appointment system.
              </p>
            </div>
          </div>
        </div>
